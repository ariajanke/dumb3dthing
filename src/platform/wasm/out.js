...
function from_js_pass_secret_array(fptr,length) { Module.HEAPF32.slice((fptr / 4), (fptr / 4) + length).forEach((n, idx) => { console.log(`secret array ${idx}: ${n}`); }); }
...
var asmLibraryArg = {
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "from_js_pass_secret_array": from_js_pass_secret_array,
...
/** @type {function(...*):?} */
var _to_js_sum_array = Module["_to_js_sum_array"] = createExportWrapper("to_js_sum_array");

/** @type {function(...*):?} */
var _to_js_reserve_temporary_buffer = Module["_to_js_reserve_temporary_buffer"] = createExportWrapper("to_js_reserve_temporary_buffer");

/** @type {function(...*):?} */
var _to_js_get_secret_array = Module["_to_js_get_secret_array"] = createExportWrapper("to_js_get_secret_array");
...
var ___start_em_js = Module['___start_em_js'] = 15380;
var ___stop_em_js = Module['___stop_em_js'] = 15542;
